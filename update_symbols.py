...
ISSUE_PARSER_OUTPUT_FILE_PATH = "~/issue-parser-result.json"
...
def main() -> None:
    ...
    with open(ISSUE_PARSER_OUTPUT_FILE_PATH, "r", encoding="utf-8") as f:
        issue_parser_result = json.load(f)

    parsed_symbols = str(issue_parser_result.symbols).splitlines()
